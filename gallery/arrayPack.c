...
static void AddDot4x4( int, double *, int, double *, int, double *, int );
static void PackMatrixA( int, double *, int, double * );
static void PackMatrixB( int, double *, int, double * );
static void InnerKernel( int, int, int, double *, int, double *, int, double *, int, int );
...
static void PackMatrixA( int k, double *a, int lda, double *a_to )
{
    int j;
...
static void PackMatrixB( int k, double *b, int ldb, double *b_to )
{
    int i;
    double
...
static void AddDot4x4( int k, double *a, int lda,  double *b, int ldb, double *c, int ldc )
{
