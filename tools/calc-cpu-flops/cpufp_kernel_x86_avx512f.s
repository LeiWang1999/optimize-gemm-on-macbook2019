.globl _cpufp_kernel_x86_avx512f_fp32
.globl _cpufp_kernel_x86_avx512f_fp64

_cpufp_kernel_x86_avx512f_fp32:
    mov $0x20000000, %rax
...
._cpufp.x86.avx512f.fp32.L1:
    ...
    sub $0x1, %rax
    jne ._cpufp.x86.avx512f.fp32.L1
    ret

_cpufp_kernel_x86_avx512f_fp64:
    mov $0x20000000, %rax
    vpxorq %zmm0, %zmm0, %zmm0
    vpxorq %zmm1, %zmm1, %zmm1
    vpxorq %zmm2, %zmm2, %zmm2
...
._cpufp.x86.avx512f.fp64.L1:
    ...
    sub $0x1, %rax
    jne ._cpufp.x86.avx512f.fp64.L1
    ret
