.globl _cpufp_kernel_x86_avx_fp32
.globl _cpufp_kernel_x86_avx_fp64

_cpufp_kernel_x86_avx_fp32:
    mov $0x40000000, %rax
...
._cpufp.x86.avx.fp32.L1:
    ...
    sub $0x1, %rax
    jne ._cpufp.x86.avx.fp32.L1
    ret

_cpufp_kernel_x86_avx_fp64:
    mov $0x40000000, %rax
